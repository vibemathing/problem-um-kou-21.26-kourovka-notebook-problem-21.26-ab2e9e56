...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.26"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-v1",
      "problem_contract_sha256": "49b98f90363f37f046d0a68f17c576f716b28c5c00ed5aa2cc06ad463afcaf91",
      "problem_id": "problem:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56",
      "route_id": "route:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-source-fidelity-01",
      "graph_id": "graph:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be a non-trivial finite group and let $p_1,\\ldots,p_k$ be the distinct prime divisors of $|G|$. For each $i$, let $H_i$ be a Sylow $p_i$-subgroup of $G$. Is it true that there exists an element $x\\in G$ such that for all $i$ the subgroup $H_i\\cap H_i^x$ is inclusion-minimal in $\\{H_i\\cap H_i^g:g\\in G\\}$?"
          },
          "statement_sha256": "a349c188ca579d6e1d96691610abc0258d24721858ead920d73f49fb3cced78f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-root",
      "route_id": "route:um-kou-21.26-kourovka-notebook-problem-21.26-ab2e9e56-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.26-b4286f063bcd",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.26"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
